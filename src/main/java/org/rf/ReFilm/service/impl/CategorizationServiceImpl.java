...
public class CategorizationServiceImpl implements CategorizationService {
    ...
    @Override
    public List<Genre> findAllByFilmIdNames(Long id) {
        return categorizationRepository.findAllByFilmIdNames(id);
    }

    @Override
    public void deleteAllByFilmId(Long id) {
        categorizationRepository.deleteAllByFilmId(id);
    }

    @Override
    public void deleteAllByFilmIdAndGenreId(Long filmId, Long genreId) {
        categorizationRepository.deleteAllByFilmIdAndGenreId(filmId, genreId);
    }
}
